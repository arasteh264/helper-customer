...
export function VerificationSection({ docs: initial }: { docs: VerificationDoc[] }) {
  ...
  return (
    ...
    >
            ...
            >
              <div className="flex flex-1 items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs leading-6 text-foreground/55">{doc.description}</p>
      ...
      <p className="mt-4 flex items-start gap-2 text-xs leading-6 text-foreground/50">
        ...
        مدارک شما فقط برای تأیید هویت استفاده می‌شود و برای مشتریان نمایش داده نمی‌شود.
      </p>
    </SectionCard>
  );
}